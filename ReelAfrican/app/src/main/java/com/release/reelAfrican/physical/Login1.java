...
import com.release.reelAfrican.activity.ExoPlayerActivity;
import com.release.reelAfrican.activity.ForgotPasswordActivity;
import com.release.reelAfrican.activity.MainActivity;
import com.release.reelAfrican.activity.MyLibraryPlayer;
import com.release.reelAfrican.activity.PPvPaymentInfoActivity;
import com.release.reelAfrican.activity.RegisterActivity;
import com.release.reelAfrican.activity.SubscriptionActivity;
import com.release.reelAfrican.activity.ThirdPartyPlayer;
import com.release.reelAfrican.activity.YouTubeAPIActivity;
...
public class Login1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_dialog = Util.LoadingCircularDialog(Login1.this);
        ...
        if ((Util.getTextofLanguage(Login1.this, Util.IS_ONE_STEP_REGISTRATION, Util.DEFAULT_IS_ONE_STEP_REGISTRATION)
                .trim()).equals("1")) {
        ...
        editEmailStr.setHint(Util.getTextofLanguage(Login1.this, Util.TEXT_EMIAL, Util.DEFAULT_TEXT_EMIAL));
      /*  editEmailStr.setOnFocusChangeListener(new View.OnFocusChangeListener() {
       ...
       /* editPasswordStr.setOnFocusChangeListener(new View.OnFocusChangeListener() {
        ...
        editPasswordStr.setHint(Util.getTextofLanguage(Login1.this,Util.TEXT_PASSWORD,Util.DEFAULT_TEXT_PASSWORD));
        ...
        forgotPassword.setText(Util.getTextofLanguage(Login1.this, Util.FORGOT_PASSWORD, Util.DEFAULT_FORGOT_PASSWORD));
        ...
        loginNewUser.setText(Util.getTextofLanguage(Login1.this,Util.NEW_HERE_TITLE,Util.DEFAULT_NEW_HERE_TITLE));
        ...
        signUpTextView.setText(Util.getTextofLanguage(Login1.this,Util.SIGN_UP_TITLE,Util.DEFAULT_SIGN_UP_TITLE));
        ...
        loginButton.setText(Util.getTextofLanguage(Login1.this, Util.LOGIN, Util.DEFAULT_LOGIN));
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Intent detailsIntent = new Intent(Login1.this, ForgotPasswordActivity.class);
        ...
        signUpTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Intent detailsIntent = new Intent(Login1.this, RegisterActivity.class);
        ...
        PlanId = (Util.getTextofLanguage(Login1.this, Util.PLAN_ID, Util.DEFAULT_PLAN_ID)).trim();
     ...
     /*   btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progressDialog = new ProgressBarHandler(Login1.this);
                progressDialog.show();
              *//* progressDialog = new ProgressDialog(Login1.this);
...
*/
      ...
      /*  loginNewUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Intent detailsIntent = new Intent(Login1.this, PurchaseHistoryActivity.class);
                detailsIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(detailsIntent);
            }
        });*/
...
/***************chromecast**********************/
    ...
    public void loginButtonClicked() {
        ...
        boolean isNetwork = Util.checkNetwork(Login1.this);
        if(isNetwork)
        {
            if ((!regEmailStr.equals("")) && (!regPasswordStr.equals("")))
            {
                ...
                {
                    Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.OOPS_INVALID_EMAIL,Util.DEFAULT_OOPS_INVALID_EMAIL));

                    //  Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this, Util.OOPS_INVALID_EMAIL, Util.DEFAULT_OOPS_INVALID_EMAIL), Toast.LENGTH_LONG).show();
                }
            }
            else
            {
                Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.ENTER_REGISTER_FIELDS_DATA,Util.DEFAULT_ENTER_REGISTER_FIELDS_DATA));

                //  Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this, Util.ENTER_REGISTER_FIELDS_DATA, Util.DEFAULT_ENTER_REGISTER_FIELDS_DATA), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
            Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.NO_INTERNET_CONNECTION,Util.DEFAULT_NO_INTERNET_CONNECTION));

            // Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this,Util.NO_INTERNET_CONNECTION,Util.DEFAULT_NO_INTERNET_CONNECTION), Toast.LENGTH_LONG).show();
        }
...
//            cred.add(new BasicNameValuePair("authToken", Util.authTokenStr.trim()));
            ...
            try {
                ...
                httppost.addHeader("lang_code",Util.getTextofLanguage(Login1.this,Util.SELECTED_LANGUAGE_CODE,Util.DEFAULT_SELECTED_LANGUAGE_CODE));

                // Added For FCM

                httppost.addHeader("device_id", Settings.Secure.getString(getContentResolver(),Settings.Secure.ANDROID_ID));
                httppost.addHeader("google_id", Util.getTextofLanguage(Login1.this,Util.GOOGLE_FCM_TOKEN,Util.DEFAULT_GOOGLE_FCM_TOKEN));
                ...
                Log.v("SUBHA","google_id" +Util.getTextofLanguage(Login1.this,Util.GOOGLE_FCM_TOKEN,Util.DEFAULT_GOOGLE_FCM_TOKEN));
           ...
           /*     try {
                ...
                try {
                    ...
                    Log.v("BIBHU2","google_id="+Util.getTextofLanguage(Login1.this,Util.GOOGLE_FCM_TOKEN,Util.DEFAULT_GOOGLE_FCM_TOKEN));
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.SLOW_INTERNET_CONNECTION,Util.DEFAULT_SLOW_INTERNET_CONNECTION));
                            //   Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this,Util.SLOW_INTERNET_CONNECTION,Util.DEFAULT_SLOW_INTERNET_CONNECTION), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            if(responseStr == null){
                ...
                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Login1.this, R.style.MyAlertDialogStyle);
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.DETAILS_NOT_FOUND_ALERT, Util.DEFAULT_DETAILS_NOT_FOUND_ALERT));
                dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK));
                dlgAlert.setCancelable(false);
                dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK),
            ...
            if (statusCode > 0) {
                ...
                if (statusCode == 200){
                    ...
                    if (Util.checkNetwork(Login1.this) == true) {
                        if (pDialog != null && pDialog.isShowing()) {
                            pDialog.hide();
                            pDialog = null;
                        }
                        //load video urls according to resolution
                        if(Util.getTextofLanguage(Login1.this,Util.IS_RESTRICT_DEVICE,Util.DEFAULT_IS_RESTRICT_DEVICE).trim().equals("1"))
                        {
                            ...
                            if (getIntent().getStringExtra("from") != null) {
                                ...
                                if (Util.check_for_subscription == 1) {
                                    ...
                                    if (PlanId.equals("1") && isSubscribedStr.equals("0")) {
                                        Intent intent = new Intent(Login1.this, SubscriptionActivity.class);
                    ...
                    AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Login1.this, R.style.MyAlertDialogStyle);
                    dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.EMAIL_PASSWORD_INVALID, Util.DEFAULT_EMAIL_PASSWORD_INVALID));
                    dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                    dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK), null);
                    dlgAlert.setCancelable(false);
                    dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK),
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressBarHandler(Login1.this);
            pDialog.show();
        }
    }
    ...
    private class AsynValidateUserDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseStr == null) {
                ...
                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Login1.this);
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.NO_DETAILS_AVAILABLE, Util.DEFAULT_NO_DETAILS_AVAILABLE));
                dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK), null);
                dlgAlert.setCancelable(false);
                dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK),
            ...
            if (status > 0) {
                if (status == 427) {
                    ...
                    if (userMessage != null && userMessage.equalsIgnoreCase("")) {
                        ...
                        dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.CONTENT_NOT_AVAILABLE_IN_YOUR_COUNTRY, Util.DEFAULT_CONTENT_NOT_AVAILABLE_IN_YOUR_COUNTRY));
                ...
                {
                    AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Login1.this);
                    dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.NO_VIDEO_AVAILABLE, Util.DEFAULT_NO_VIDEO_AVAILABLE));
                    dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                    dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK), null);
                    dlgAlert.setCancelable(false);
                    dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this, Util.BUTTON_OK, Util.DEFAULT_BUTTON_OK),
...
//                httppost.addHeader("internet_speed",MainActivity.internetSpeed.trim());
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            responseStr = "0";
                            Util.dataModel.setVideoUrl(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA));
                            Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.SLOW_INTERNET_CONNECTION,Util.DEFAULT_SLOW_INTERNET_CONNECTION));
              ...
              /*  JSONObject myJson =null;
                ...
                if (statusCode >= 0) {
                    if (statusCode == 200) {
                        if (Util.dataModel.getThirdPartyUrl().matches("") || Util.dataModel.getThirdPartyUrl().equalsIgnoreCase(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA))) {
                            if ((myJson.has("studio_approved_url")) && myJson.getString("studio_approved_url").trim() != null && !myJson.getString("studio_approved_url").trim().isEmpty() && !myJson.getString("studio_approved_url").trim().equals("null") && !myJson.getString("studio_approved_url").trim().matches("")) {
                                ...
                                if ((myJson.has("videoUrl")) && myJson.getString("videoUrl").trim() != null && !myJson.getString("videoUrl").trim().isEmpty() && !myJson.getString("videoUrl").trim().equals("null") && !myJson.getString("videoUrl").trim().matches("")) {
                                    ...
                                    Util.dataModel.setMpdVideoUrl(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA));
                                }
                            }
                        ...
                        // This is added because of change in simultaneous login feature
                        if(Util.getTextofLanguage(Login1.this,Util.IS_STREAMING_RESTRICTION,Util.DEFAULT_IS_IS_STREAMING_RESTRICTION).equals("1"))
                        {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseStr == null) {
                responseStr = "0";
                Util.dataModel.setVideoUrl(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA));
                //movieThirdPartyUrl = Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA);
            }
            ...
            if ((responseStr.trim().equalsIgnoreCase("0"))) {
                ...
                if (Util.dataModel.getVideoUrl() == null) {
                    ...
                    dlgAlert.create().show();
                } else if (Util.dataModel.getVideoUrl().matches("") || Util.dataModel.getVideoUrl().equalsIgnoreCase(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA))) {
                    try {
                        if (pDialog != null && pDialog.isShowing()) {
                            pDialog.hide();
                            pDialog = null;
                    ...
                    if (Util.dataModel.getThirdPartyUrl().matches("") || Util.dataModel.getThirdPartyUrl().equalsIgnoreCase(Util.getTextofLanguage(Login1.this, Util.NO_DATA, Util.DEFAULT_NO_DATA))) {
                        if (mCastSession != null && mCastSession.isConnected()) {
                            ...
                            if (Util.dataModel.getVideoUrl().contains("rtmp://") || Util.dataModel.getVideoUrl().contains("rtmp://")) {
                                Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this, Util.VIDEO_ISSUE, Util.DEFAULT_VIDEO_ISSUE), Toast.LENGTH_SHORT).show();
                            } else {
                                final Intent playVideoIntent;

                                playVideoIntent = new Intent(Login1.this, ExoPlayerActivity.class);
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        if (FakeSubTitlePath.size() > 0) {
                                            ...
                                            progressBarHandler = new ProgressBarHandler(Login1.this);
                        ...
                        if (Util.dataModel.getVideoUrl().contains("://www.youtube") || Util.dataModel.getVideoUrl().contains("://www.youtu.be")) {
                            if (Util.dataModel.getVideoUrl().contains("live_stream?channel")) {
                                final Intent playVideoIntent = new Intent(Login1.this, ThirdPartyPlayer.class);
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        playVideoIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                        startActivity(playVideoIntent);
                                ...
                                final Intent playVideoIntent = new Intent(Login1.this, YouTubeAPIActivity.class);
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        playVideoIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                        startActivity(playVideoIntent);
  ...
  /*  private class AsynCheckFbUserDetails extends AsyncTask<Void, Void, Void> {
         ...
         *//*   if (isNewUserStr == 1) {
            ...
            if (status == 0) {
                ...
                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Login1.this);
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.NO_RECORD, Util.DEFAULT_NO_RECORD));
                dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK));
                dlgAlert.setCancelable(false);
                dlgAlert.setPositiveButton(Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK),
    ...
    private void loadRemoteMedia(int position, boolean autoPlay) {
        ...
        remoteMediaClient.addListener(new RemoteMediaClient.Listener() {
            ...
            public void onStatusUpdated() {
                ...
                Intent intent = new Intent(Login1.this, ExpandedControlsActivity.class);
                startActivity(intent);
                InputMethodManager inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
                inputMethodManager.hideSoftInputFromWindow(getCurrentFocus().getWindowToken(), 0);
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            else
            {
                ...
                {
                    playVideoIntent = new Intent(Login1.this, MyLibraryPlayer.class);
                }
                else
                {
                    playVideoIntent = new Intent(Login1.this, ExoPlayerActivity.class);
...
//
        ...
        public void onCancel() {
            ...
            loginWithFacebookButton.setVisibility(View.GONE);
            btnLogin.setVisibility(View.VISIBLE);
            Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.DETAILS_NOT_FOUND_ALERT,Util.DEFAULT_DETAILS_NOT_FOUND_ALERT));

            //Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this, Util.DETAILS_NOT_FOUND_ALERT, Util.DEFAULT_DETAILS_NOT_FOUND_ALERT), Toast.LENGTH_LONG).show();
            //progressDialog.dismiss();
        }
    ...
    private class AsynCheckFbUserDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status == 0) {
                ...
                android.app.AlertDialog.Builder dlgAlert = new android.app.AlertDialog.Builder(Login1.this, R.style.MyAlertDialogStyle);
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this, Util.DETAILS_NOT_FOUND_ALERT, Util.DEFAULT_DETAILS_NOT_FOUND_ALERT));
                dlgAlert.setTitle(Util.getTextofLanguage(Login1.this, Util.SORRY, Util.DEFAULT_SORRY));
                dlgAlert.setMessage(Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK));
                dlgAlert.setCancelable(false);
    ...
    {
        {
            ...
            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Login1.this, R.style.MyAlertDialogStyle);
            LayoutInflater inflater = (LayoutInflater) Login1.this.getSystemService(Login1.this.LAYOUT_INFLATER_SERVICE);
            ...
            ok.setText(" "+ Util.getTextofLanguage(Login1.this,Util.BUTTON_OK,Util.DEFAULT_BUTTON_OK));
            cancel.setText(" "+ Util.getTextofLanguage(Login1.this,Util.CANCEL_BUTTON,Util.DEAFULT_CANCEL_BUTTON));
    ...
    private class AsynSimultaneousLogout extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (statusCode == 200) {
                ...
                Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.SIMULTANEOUS_LOGOUT_SUCCESS_MESSAGE,Util.DEFAULT_SIMULTANEOUS_LOGOUT_SUCCESS_MESSAGE));


                //  Toast.makeText(getApplicationContext(),Util.getTextofLanguage(Login1.this,Util.SIMULTANEOUS_LOGOUT_SUCCESS_MESSAGE,Util.DEFAULT_SIMULTANEOUS_LOGOUT_SUCCESS_MESSAGE),Toast.LENGTH_LONG).show();

            } else {
                Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.TRY_AGAIN,Util.DEFAULT_TRY_AGAIN));

                // Toast.makeText(getApplicationContext(),Util.getTextofLanguage(Login1.this,Util.TRY_AGAIN,Util.DEFAULT_TRY_AGAIN),Toast.LENGTH_LONG).show();
            }
        }

        @Override
        protected void onPreExecute() {
            progressDialog1 = new ProgressDialog(Login1.this,R.style.MyTheme);
    ...
    public void ShowPpvPopUp()
    {
        ...
        try {
            if (Util.currencyModel.getCurrencySymbol() == null) {
                Util.showToast(Login1.this, Util.getTextofLanguage(Login1.this,Util.NO_DETAILS_AVAILABLE,Util.DEFAULT_NO_DETAILS_AVAILABLE));

                //  Toast.makeText(Login1.this, Util.getTextofLanguage(Login1.this, Util.NO_DETAILS_AVAILABLE, Util.DEFAULT_NO_DETAILS_AVAILABLE), Toast.LENGTH_LONG).show();
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Login1.this, R.style.MyAlertDialogStyle);
        LayoutInflater inflater = (LayoutInflater) Login1.this.getSystemService(Login1.this.LAYOUT_INFLATER_SERVICE);
       ...
       /*
        ...
        payNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.dismiss();
                final Intent showPaymentIntent = new Intent(Login1.this, PPvPaymentInfoActivity.class);
    ...
    private class AsynLogoutDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            try {
                ...
                Toast.makeText(Login1.this,Util.getTextofLanguage(Login1.this, Util.SIGN_OUT_ERROR, Util.DEFAULT_SIGN_OUT_ERROR),Toast.LENGTH_LONG).show();
    ...
    public void ShowVoucherPurchaseTypePopUp(String isShow,String isSeason,String isEpisode)
    {
        ...
        completeRadioButton.setText("  " + Util.dataModel.getParentTitle().trim() +" "+ Util.getTextofLanguage(Login1.this,Util.COMPLETE_SEASON,Util.DEFAULT_COMPLETE_SEASON).toString().toLowerCase()+" ");
        seasonRadioButton.setText("  "+Util.dataModel.getParentTitle().trim() +" "+ Util.getTextofLanguage(Login1.this,Util.SEASON,Util.DEFAULT_SEASON).toString().toLowerCase()+" "+ Util.dataModel.getSeason_id().trim() + " ");
        ...
        heading.setText(Util.getTextofLanguage(Login1.this,Util.SELECT_PURCHASE_TYPE,Util.DEFAULT_SELECT_PURCHASE_TYPE).toString().toLowerCase());
        payNowButton.setText(Util.getTextofLanguage(Login1.this,Util.BTN_NEXT,Util.DEFAULT_BTN_NEXT).toString().toLowerCase());
    ...
    public void ShowVoucherPopUp(String ContentName)
    {
        ...
        content_label.setText(" "+ Util.getTextofLanguage(Login1.this,Util.PURCHASE,Util.DEFAULT_PURCHASE).toString().toLowerCase()+" : ");
        voucher_success.setText(" "+ Util.getTextofLanguage(Login1.this,Util.VOUCHER_SUCCESS,Util.DEFAULT_VOUCHER_SUCCESS).toString().toLowerCase()+" ");
        apply.setText(" "+ Util.getTextofLanguage(Login1.this,Util.BUTTON_APPLY,Util.DEFAULT_BUTTON_APPLY).toString().toLowerCase()+" ");
        watch_now.setText(" "+ Util.getTextofLanguage(Login1.this,Util.WATCH_NOW,Util.DEFAULT_WATCH_NOW).toString().toLowerCase()+" ");
        voucher_code.setHint(" "+ Util.getTextofLanguage(Login1.this,Util.VOUCHER_CODE,Util.DEFAULT_VOUCHER_CODE).toString().toLowerCase()+" ");
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),Util.getTextofLanguage(Login1.this,Util.VOUCHER_BLANK_MESSAGE,Util.DEFAULT_VOUCHER_BLANK_MESSAGE), Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                Intent mycart = new Intent(Login1.this, MyCartActivity.class);
