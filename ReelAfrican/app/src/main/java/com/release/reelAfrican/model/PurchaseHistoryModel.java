...
public class PurchaseHistoryModel {
    ...
    String Invoice, OrderId, PurchaseDate, TransactionStatus, Amount, TransctionActiveInactive, Oid, Contenttype;
    ...
    public PurchaseHistoryModel(String invoiec, String orderId, String purchaseDate, String transactionStatus, String amount, String transctionActiveInactive, String Oid, String Contenttype) {
        Invoice = invoiec;
        OrderId = orderId;
