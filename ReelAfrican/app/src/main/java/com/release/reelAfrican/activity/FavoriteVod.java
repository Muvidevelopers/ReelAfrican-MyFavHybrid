...
public class FavoriteVod extends Fragment {
...
//                                    moviePermalinkStr = "chit-kwint-she-the";
                                ...
                                //videoTypeIdStr = "1";
//
                                Log.v("nihar_c", videoImageStr + "/" + videoName + "/" + videoTypeIdStr + "/" + videoPermalinkStr + "/" + isEpisodeStr + "/" + isConverted + "/" + isPPV + "/" + isAPV);
