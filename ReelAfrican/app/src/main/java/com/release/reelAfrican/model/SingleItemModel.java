...
public class SingleItemModel {
    ...
    public SingleItemModel(String imageId, String title, String videoType, String videoTypeId, String movieGenre, String videoUrl, String permalink, String isEpisode, String movieUniqueId, String movieStreamUniqueId, int isConverted, int isPPV, int isAPV,String producttitle,String productimage,String productprice) {
        super();
        this.imageId = imageId;
        this.title = title;
        this.videoType = videoType;
