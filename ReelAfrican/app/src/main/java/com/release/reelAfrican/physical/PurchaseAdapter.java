...
public class PurchaseAdapter extends RecyclerView.Adapter<PurchaseAdapter.ViewHolder>{
    Context context;
    ArrayList<PurchaseHmodel> purchaseData;


    public PurchaseAdapter(Context context, ArrayList<PurchaseHmodel> purchaseData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapterpurchasehistory, viewGroup, false);
...
//        }
        ...
        holder.transactionOrderTextView.setText(purchaseData.get(position).getId());
        holder.transactionPurchaseDateTextView.setText(purchaseData.get(position).getPurchasedate());
        holder.showPriceTextView.setText(purchaseData.get(position).getCurrencysymbol()+purchaseData.get(position).getAmount());
